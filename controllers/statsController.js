...
const getRentalTrends = async (req, res) => {
  try {
    ...
    const mockTrends = [
      { name: 'Tháng 1', revenue: 15000000, inquiries: 40 },
      { name: 'Tháng 2', revenue: 18000000, inquiries: 45 },
      { name: 'Tháng 3', revenue: 20000000, inquiries: 55 },
      { name: 'Tháng 4', revenue: 12000000, inquiries: 30 },
      { name: 'Tháng 5', revenue: 25000000, inquiries: 70 },
      { name: 'Tháng 6', revenue: 22000000, inquiries: 60 },
    ];
